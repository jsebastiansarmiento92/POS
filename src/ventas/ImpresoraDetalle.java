 ...
 * @author jseba
 */
public class ImpresoraDetalle {

//private CajaAd ad;
    void imprimirTicket(String subTotal, String total) {
        // this.ad=ad;
        try {
            ...
            int filas = ventas.CajaDetalle.tablaCajaDetalle.getRowCount();
            ...
            printer.printTextWrap(5, 0, 0, 50, "Fecha Venta: " + ventas.CajaDetalle.fechaDetalle.getText()); //Aqui va la fecha de recibo
            printer.printTextWrap(5, 0, 26, 50, "Hora copia:" + principal.MenuPrincipalAd.hora.getText()); //Aqui va la hora de recibo
            printer.printTextWrap(6, 0, 3, 50, "Numero : " + ventas.CajaDetalle.numFacDetalle.getText()); //Numero del recibo - FACTURA O PEDIDO
            ...
            for (int i = 0; i < filas; i++) {
                ...
                printer.printTextWrap(p, 1, 0, 19, ventas.CajaDetalle.tablaCajaDetalle.getValueAt(i, 0).toString());
                printer.printTextWrap(p, 1, 5, 19, ventas.CajaDetalle.tablaCajaDetalle.getValueAt(i, 2).toString());
                printer.printTextWrap(p, 1, 18, 30, ventas.CajaDetalle.tablaCajaDetalle.getValueAt(i, 3).toString());
                printer.printTextWrap(p, 1, 29, 38, ventas.CajaDetalle.tablaCajaDetalle.getValueAt(i, 4).toString());
                String pre = printer.alinharADireita(10, ventas.CajaDetalle.tablaCajaDetalle.getValueAt(i, 5).toString());
            ...
            printer.printTextWrap(filas + 9, 1, 20, 50, "$" + ventas.CajaDetalle.totalDetalle.getText());

            String tot = printer.alinharADireita(10, total);
            printer.printTextWrap(filas + 10, 1, 0, 50, "Total a pagar: ");
            printer.printTextWrap(filas + 10, 1, 20, 50, "$" + ventas.CajaDetalle.totalDetalle.getText());


            printer.printTextWrap(filas + 11, 1, 0, 50, "================================================");
