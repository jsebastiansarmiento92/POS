...
public class ListaAlimentosAd extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(enviar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 10, 90, 100));
	...
	private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        for (int i = 0; i < ventas.CajaAd.tablaCaja.getRowCount(); i++) {
            ...
            ventas.CajaAd.tablaCaja.setValueAt(formatea.format(Math.rint(imp * 100)/ 100), i, 5);
...
public int redondear(int numero){
    ...
    private void enviar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviar1ActionPerformed
        ...
        if (tablaProductos.getRowCount() > 0) {
                try {
                    ...
                    if (fila == -1) {
                        ...
                        if (tipo.equalsIgnoreCase("BASCULA")) {
                            ...
                            String valor=basculaIni.lecturaFija();
                            System.out.println("valor"+valor);
                            System.out.println("peso"+basculaIni.getPeso());
                            double valorPeso = Double.parseDouble(valor);
                           // basculaIni.iniLectura();
                                ...
                                for (int i = 0; i < ventas.CajaAd.tablaCaja.getRowCount(); i++) {
                                    ...
                                    if (cod.equals(com)) {
                                       ...
                                       // DecimalFormat formatea = new DecimalFormat("###,###.##");
                                        ...
                                        ventas.CajaAd.tablaCaja.setValueAt(cantT, i, 4);
            ...
            ventas.CajaAd.buscar.requestFocus();
           this.dispose();
